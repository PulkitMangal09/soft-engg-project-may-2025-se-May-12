<template>
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <form v-if="userType === 'student'" @submit.prevent="submitStudentProfile" class="space-y-4">
                <div>
            ...
            <form v-else-if="userType === 'teacher'" @submit.prevent="submitTeacherProfile" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">School Name *</label>
            ...
            <!-- Parent Profile Form -->
            <form v-else-if="userType === 'parent'" @submit.prevent="submitParentProfile" class="space-y-4">
                <div>
            ...
            <div class="flex justify-end space-x-3 mt-6">
                ...
                <button @click="submitProfile" :disabled="loading"
